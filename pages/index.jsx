      ...
      <Jumbotron fluid='true' className='bg-white'>
        <Container id="practice">
          ...
          <div class="row featurette align-items-center">
            ...
            <div class="col-md-5">
              <img src="/meeting.jpg" class="featurette-image img-fluid mx-auto box-shadow rounded" />
            </div>
          </div>
          ...
          <div class="row featurette align-items-center">
            ...
            <div class="col-md-5 order-md-1">
              <img src="/code.jpg" class="featurette-image img-fluid mx-auto box-shadow rounded" />
            </div>
          </div>
          ...
          <div class="row featurette align-items-center">
            ...
            <div class="col-md-5">
              <img src="/clock.jpg" class="featurette-image img-fluid mx-auto box-shadow rounded" />
            </div>
          </div>
        </Container>
      </Jumbotron>
